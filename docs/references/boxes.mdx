...
<!-- - `invitation_data`: (object) (optional) only available using `com.misakey.nacl-enc` algorithm: see [the invitation data guide](/guides/store-data-for-your-org.mdx#invitation-data) for more information)  -->
