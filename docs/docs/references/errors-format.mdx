...
:warning: Please contact the backend team if you receive one these codes.
...
:warning: Please contact the backend team if you receive one of these origins.
...
:warning: Please contact the backend team if you receive one of these detail values.
