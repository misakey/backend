...
Events are mainly used in the endpoints described [here](/old-doc/endpoints/boxes.md) and [here](/old-doc/endpoints/box_events.md).
...
For more information on box key shares, see [here](/old-doc/endpoints/box_key_shares.md).
...
(through [crypto actions](/old-doc/endpoints/crypto_actions.md)):
